...
module.exports = {
    ...
    async getChannelUsers(req, res) {
        try {
            ...
            res.send(_.uniqBy(channelUsers, channelUser => channelUser.UserId))
        } catch (err) {
            res.status(500).send({
                err: 'An error has occured while trying to get the channel users'
            })
        }
    },
    async post(req, res) {
        try {
            ...
            res.status(500).send({
                err: 'An error has occured while trying to create the channel for the user'
            })
        }
    },
    async delete(req, res) {
        try {
            ...
            res.status(500).send({
                err: 'An error has occured while trying to delete the channel user'
            })
        }
    }
}